  ...
  return (
    <div className="w-full bg-card border border-border rounded-xl overflow-hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          {hasFilters && (
            <button
              ...
              className="inline-flex items-center gap-1 px-3 py-2 text-xs text-muted-foreground hover:text-foreground bg-secondary rounded-lg hover:bg-secondary/80 transition-colors"
            >
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm text-muted-foreground min-w-[900px]">
                  ...
                  <React.Fragment key={l.id}>
                    <tr
                      ...
                      className={`border-b border-border/50 transition-colors ${
                        hasMeta ? "cursor-pointer hover:bg-muted/50" : "hover:bg-muted/30"
                      }`}
                    >
                      ...
                      <td className="px-6 py-4 font-mono text-xs text-foreground/80 break-all">
                        {l.resource}
                      </td>
                      <td className="px-6 py-4">
                        {l.decision ? (
                          <span className="text-foreground/80 font-mono text-xs">{l.decision}</span>
                        ) : (
                      ...
                      <tr className="bg-muted/40">
                        <td colSpan={6} className="px-6 py-4">
                          <div className="rounded-lg border border-border bg-muted p-4">
                            ...
                            <pre className="text-xs text-emerald-700 dark:text-emerald-300/90 font-mono overflow-x-auto whitespace-pre-wrap break-all">
                              {(() => {
                                try {
