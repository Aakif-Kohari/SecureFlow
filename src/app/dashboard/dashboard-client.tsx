    ...
    try {
      ...
      const skippedNote =
        res.skipped && res.skipped > 0
          ...
          : "";
      const failedNote = res.failed && res.failed > 0 ? ` ${res.failed} could not be saved.` : "";
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-2">
              ...
              <h2 className="text-xl font-headline font-bold">
                Install SecureFlow GitHub Application
              </h2>
              <p className="text-sm text-muted-foreground max-w-2xl">
                To begin automated vulnerability defense and real-time pull request auditing,
                install the SecureFlow GitHub App on your organization or repositories.
              </p>
            </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <RefreshCw
              className={`w-3.5 h-3.5 mr-2 ${isSyncing ? "animate-spin text-primary" : ""}`}
            />
          ...
          <CardContent className="h-[300px]">
            {chartData.length === 0 ? (
              <div className="flex h-full flex-col items-center justify-center rounded-xl border border-dashed border-foreground/10 text-center">
                ...
                <h3 className="text-lg font-semibold">No Scan Activity</h3>
          ...
          <CardContent>
            {totalFindings === 0 ? (
              <div className="flex flex-col items-center justify-center py-10 text-center">
                ...
                <h3 className="text-lg font-semibold">No Security Findings</h3>
          ...
          <div className="space-y-4">
            {prs.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-foreground/10 py-14 text-center">
                ...
                <p className="mt-2 max-w-sm text-sm text-muted-foreground">
                  Connect a repository and run a scan to view pull requests, security findings, and
                  policy results here.
                </p>
              </div>
            ) : (
